...
echo "<div class='wall'><h3>$name1 Messages</h3>";
echo <<<_END
...
<input type='submit' value='Post Message' class='flat-button'/></form><br />
_END;
if (isset($_GET['erase']))
{
...
echo "<br /><a class='flat-button' href='messages.php?view=$view' style='text-decoration: none'>Refresh messages</a></div>";?>
